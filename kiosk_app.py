...
# ==========================================
# 1. إعدادات الصفحة ودعم اللغة العربية (RTL)[cite: 7]
# ==========================================
...
if prompt := st.chat_input("اكتب استفسارك هنا (مثال: كيف أتواصل مع شؤون التعليم؟)"):
    ...
    with st.chat_message("assistant"):
        ...
        try:
            ...
            - مبرمجك ومطورك هو المهندس "علي عطيه الزهراني".
            - الطالب الذي يتحدث معك عبر الشاشة مجهول الهوية، عامله بصيغة الاحترام العامة.
            ...
            - وحدة الشؤون التعليمية: لأي أسئلة عن (الجداول، الحذف والإضافة، الحرمان، الشؤون الأكاديمية)، وجهه للإيميل: ac.edu@UJ.EDU.SA
